...
import AddSubcategoryTitleModal from './components/AddSubcategoryTitleModal/AddSubcategoryTitleModal';
...
function ManageFiltersPage() {
  ...
  console.log('rrrrrrrrrrrrrrr refreshState', refreshState);
