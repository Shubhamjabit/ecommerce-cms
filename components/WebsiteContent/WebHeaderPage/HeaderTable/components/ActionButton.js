...
import { EyeFilled, EyeInvisibleFilled, SendOutlined, DeleteOutlined, EditOutlined  } from "@ant-design/icons";
import {useDispatch} from 'react-redux';
import { setBanner } from "../../../../../store/actions/bannerActions";

const ActionButton = ({ showModal1, showModal2, showModal3, showModal4, header}) => {
  ...
  return (
    <Row className={styles.dashboardProductTableAction} >
       <Button
        ...
        onClick={() => {
          dispatch(setBanner(header));
            console.log("dispatch",header);
            showModal4();
