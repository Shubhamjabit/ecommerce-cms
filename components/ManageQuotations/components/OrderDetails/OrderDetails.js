...
function OrderDetails({
  ...
  const sendShippingEmail = async () => {
    ...
    try {
      await axios
        .post(`${envUrl.baseUrl}${cmsendPoint.sendShippingEmail}`, emailJson, {
          headers: {
            'Access-Control-Allow-Origin': '*',
            'Content-Type': 'application/json',
          },
            ...
            <Grid container display={'row'} spacing={3}>
              ...
              <Grid item xs={12} md={6} lg={6}>
                <div className={styles.ItemBoxes}>
                  ...
                  <div className={styles.ContentBody}>
                    <p>
                      <strong>{orderDetails.deliveryAddressStreet}</strong>
                    </p>
                  </div>
                </div>
              </Grid>
                            ...
                            >
                              ...
                              <TableCell align="center">
                                <InputNumber
                                  ...
                                  value={
                                    item.quantity -
                                    (item.qtyAlreadyShipped + item.qtyShipped)
                                  }
                                ></InputNumber>
                              </TableCell>
                              <TableCell align="right">
                                ${item.lineItemTotalPrice}
                              </TableCell>
                              <TableCell align="right">
                                ${item.discountAmount}
                              </TableCell>
                ...
                <div className={styles.ItemBoxes}>
                  ...
                  <div className={styles.ContentBody}>
                    ...
                    <div className={styles.boxContainer}>
                      ...
                      {isDisableSubmit ? (
                        <Tooltip
                          title="Quantity pending cannot be negative"
                          color="red"
                          placement="right"
                        >
                          <Button
